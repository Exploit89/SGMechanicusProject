...
class ResearchWindow(QtWidgets.QWidget):

    def __init__(self, parent=None):
        super(ResearchWindow, self).__init__(parent, flags=QtCore.Qt.Window | QtCore.Qt.MSWindowsFixedSizeDialogHint |
