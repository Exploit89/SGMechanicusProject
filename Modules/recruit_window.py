...
class RecruitWindow(QtWidgets.QWidget):

    def __init__(self, parent=None):
        super(RecruitWindow, self).__init__(parent, flags=QtCore.Qt.Window | QtCore.Qt.MSWindowsFixedSizeDialogHint |
                                       QtCore.Qt.FramelessWindowHint)
        self.setWindowModality(QtCore.Qt.WindowModal)
        self.setWindowTitle("Recruit")
        self.resize(900, 500)
        self.label = QLabel(self, alignment=Qt.AlignCenter | Qt.AlignTop)  # Новый лейбл для окна без рамки
        self.label.setText("Recruit")
