...
class ShipTreeView(QtWidgets.QTreeView):
    ...
    def __init__(self, parent=None):
        ...
        shower_shiplist_name = QtGui.QStandardItem('Shower')
        snowfall_shiplist_name = QtGui.QStandardItem('Snowfall')
        ...
        t3_frigate_list = (shower_shiplist_name, snowfall_shiplist_name)
        ...
        for i in range(len(t3_frigate_list)):
            stditem = QtGui.QStandardItem(t3_frigate_list[i])
            t3_frigate_class.appendRow([stditem])
