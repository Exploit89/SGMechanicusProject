...
class ImplantWindow(QtWidgets.QWidget):

    def __init__(self, parent=None):
        super(ImplantWindow, self).__init__(parent, flags=QtCore.Qt.Window | QtCore.Qt.MSWindowsFixedSizeDialogHint |
